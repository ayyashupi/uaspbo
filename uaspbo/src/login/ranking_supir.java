 ...
 * @author ayyash
 */
public class ranking_supir extends javax.swing.JFrame {
    
    /**
     * Creates new form register
     */
    public ranking_supir() {
        initComponents();
        tampil_laporan();
    }
...
//                            "MonthName(tgl_pinjam) LIKE'%\"+filter+\"%' group by penyewa.id_penyewa order by transaksi.total desc";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Supir", "Nama Supir", "No Telp", "Biaya", "Jumlah Customer", "Peringkat"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ranking_supir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ranking_supir().setVisible(true);
            }
        });
    }
 private void bersih(){
